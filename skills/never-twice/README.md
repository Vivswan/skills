...
- Audits every deletion of a rule, guard, or check (Chesterton's Fence): each maps to a successor covering its class or a named deliberate cut, or nothing lands
