...
- **No AI or tool attribution, anywhere.** No `Generated by`, no bot `Co-Authored-By:` trailers, no agent names; none in commit messages, PR descriptions, or files. Keep the Git author identity as the human author's own.
