...
`/code-standards` packages house standards for maintainable code and the artifacts around it, each with a concrete specimen:
...
- Applies the standards while writing code, then checks them again at review time
