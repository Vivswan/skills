...
- **Line accounting before landing**: additions and deletions summed per kind (source, scripts, tests, docs, workflows, generated) and read against the stated purpose; a simplification whose target kind is not net negative blocks until trimmed or explained
