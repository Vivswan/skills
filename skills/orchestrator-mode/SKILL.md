...
4. In the PR gate, read `references/landing.md` BEFORE fanning out: dependency-based (stacked) tracks initialize their chain (`gh stack init`) before builders spawn, and every brief must name who pushes and opens each draft PR.
