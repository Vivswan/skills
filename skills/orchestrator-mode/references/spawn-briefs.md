...
Rules: no TODO/FIXME markers; do the work or escalate it. Comments only
  ...
  name, real account logins, hostnames, home paths, emails): example
  names only (`work-bot`, `example-user`, `example.com`, `/home/user`). Directives and your own steps must be safe
